...
// add way to process uranium with TE
...
// make uranium from yellorium
recipes.addShapeless(<ic2:itemmisc:55>, [<bigreactors:ingotyellorium>]);

// make yellorium from uranium
recipes.addShapeless(<bigreactors:ingotyellorium>, [<ic2:itemmisc:55>]);
